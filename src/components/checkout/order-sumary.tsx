    ...
    <div className="w-1/2 self-start rounded-lg border border p-6">
          ...
          <li key={product.id} className='flex items-center gap-4 py-4'>
            ...
            <div className="flex flex-1 flex-col">
              <div className="flex flex-1 items-center justify-between">
                ...
                <span className="text-gray-500">{formatPrice(product.price * product.quantity / 100)}</span>
              </div>

              <span className="text-md text-gray-500">Quantidade: {product.quantity}</span>
            </div>
          </li>
        ))}
      </ul>
      ...
      <div className="flex flex-col gap-2 border-t pt-4">
        <div className="flex items-center justify-between">
          ...
          <span className="text-gray-500">{formatPrice(shippingTax / 100)}</span>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-2 border-t pt-4">
        <div className="flex items-center justify-between">
          ...
          <span className="text-gray-500">{formatPrice((total + shippingTax) / 100)}</span>
        </div>
      </div>
